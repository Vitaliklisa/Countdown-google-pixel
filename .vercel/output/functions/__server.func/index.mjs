...
var grokOgIdentity = { "site": {
	"title": "Until",
	"card": "custom",
	"description": "Pick a future day and count the years, months, days, and hours — then celebrate when it arrives.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_6_Snp1 = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_6_Snp1
	};
	return ((_m, p) => {
		return {
			data,
